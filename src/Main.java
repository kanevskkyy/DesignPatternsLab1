...
import creational.factory.DeveloperType;
...
public class Main {
    public static void main(String[] args) {
        /*Fabric Method*/
        Developer javaDeveloper = DeveloperFactory.createDeveloper(DeveloperType.JAVA);
        javaDeveloper.writeCode();

        Developer cppDeveloper = DeveloperFactory.createDeveloper(DeveloperType.C_PLUS_PLUS);
